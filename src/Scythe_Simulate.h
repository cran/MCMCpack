...
/* Many of these function were ported (with few modifications) from
 * the GPL'd R Project For Statistical Computing
 */
...
namespace SCYTHE {
  ...
  /**********************************************************************/
  //  FUNCTION:  rnchypgeom(): returns a pseudo-random deviate from a
  //                            non-central hypergeometric distribution
  //  
  //  Input:     const double&, const double&, const double&, const double&, 
  //             const double&, const double&
  //  Return:    double
  //  Usage:     double y = rnchypgeom(m1, n1, n2, psi, delta)
  //  Errors: ????
  //  Dependencies: ????
  //  References: Uses algorithm of Liang and Rosen. 2001. "Fast and Stable
  //              Algorithms for Computing and Sampling From the Noncentral 
  //              Hypergeometric Distribution", The American Statistician,
  //              55: 366-369.
  //
